...
Auth.post(
   ...
   `  #swagger.tags = ['Auth']
      #swagger.description = `
         ...
         ✅ Generates an <b>activation token</b>
...
Auth.post(
   ...
   `  #swagger.tags = ['Auth']
      #swagger.description = `
         ✅ Checks if any user belongs to provided email address
         ✅ Makes sure that user account is activated
         ✅ Generates <b>password token</b> to authorize changing password in the next step (password form)
      #swagger.parameters['email'] = {
         in: 'body',
         description: 'User email',
         required: 'true',
...
Auth.post(
   ...
   `  #swagger.tags = ['Auth']
      #swagger.description = `
         ✅ Checks password token generated by <b>/api/user/auth/recoverPassword</b>
         ✅ Checks if there is a user with email address as kept in password token 
