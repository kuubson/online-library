...
-  custom local lib [@online-library/core](https://github.com/kuubson/online-library/tree/master/@online-library/core)[^t]
...
[^t]: @online-library/core - lib for sharing stuff between apps. It exposes `API.ts` which transforms autogenerated API docs into usable `API` variable
