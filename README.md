...
| [Stack](#-stack) | [Notes](#-some-notes) | [Docs](#-documentation) | [Flow](#-flow) | [App preview](#-app-preview) | [Native app]() | [Automation](#-automation) | [Tools](#-side-tools) | [Scripts](#-root-scripts) | [Env](#-environment-variables) | [Future goals](#-future-goals) |
| ---------------- | --------------------- | ----------------------- | -------------- | ---------------------------- | -------------- | -------------------------- | --------------------- | ------------------------- | ------------------------------ | ------------------------------ |
...
-  **CircleCI** + 🔥 **Firebase App Distribution** for a native app
...
| command           | server                                                                                                             | web                         | all packages                    |
| ----------------- | ------------------------------------------------------------------------------------------------------------------ | --------------------------- | ------------------------------- |
