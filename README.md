...
| `yarn lint`        | triggers `lint` pipeline ~> ts & eslint & stylelint check, through[^w][^s][^t]                                                              |
...
| `yarn lib`         | triggers filterred `build` pipeline ~> builds only[^t]                                                                                      |
...
| `SEQUELIZE_AUTO`                                                        | ✔️                  | ❌                                 | set to `true` to re-autogenerate db models from existing tables (generates ✔️ methods for associations)       |
| `SEED_BOOKS`                                                            | ✔️                  | ❌                                 | set to `true` to seed db with random books                                                                    |
| `SEED_USER`                                                             | ✔️                  | ❌                                 | set to `true` to seed db with testing user books                                                              |
